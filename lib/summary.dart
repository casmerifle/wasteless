                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                                child: Column(
                                    children: <Widget>[
                                      Expanded(
                                          child: Text("Your recyclables this week:", textAlign: TextAlign.center)
                                      ),
                                      Expanded(
                                          child: Text("0.41kg", textAlign: TextAlign.center)
                                      )
                                    ]
                                )
                            ),
                            ...
                            Expanded(
                                child: Column(
                                    children: <Widget>[
                                      ...
                                      Expanded(
                                          child: Text("0.20kg", textAlign: TextAlign.center)
                                      )
                                    ]
                                )
                            )
